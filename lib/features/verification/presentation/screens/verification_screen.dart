...
class _VerificationScreenState extends State<VerificationScreen> {
  ...
  Future<void> _verify([String? id]) async {
    final value = (id ?? _controller.text).trim();
        ...
        child: ConstrainedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Check authenticity offline using the locally stored document hash and issuer signature.',
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: FilledButton.icon(
                        ...
                        label: Text(
                          _checking ? 'Verifying…' : 'Verify offline',
                        ),
                      ),
                    ),
                  ],
      ...
      child: Column(
        ...
        children: [
          ...
          if (result.isValid) ...[
            ...
            _Info(
              label: 'Student class',
              value: result.studentClass ?? 'Not provided',
            ),
            _Info(label: 'Course', value: result.course ?? 'Not provided'),
          ] else
            Text(
              result.reason ?? 'Unknown verification error',
