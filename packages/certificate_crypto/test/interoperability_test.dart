...
void main() {
  ...
  test('versioned QR payload round trip and tamper rejection', () async {
    ...
    expect(payload.startsWith(legacyQrScheme), isTrue);
    ...
    expect(() => decodeVerificationQrPayload(payload.replaceFirst(legacyQrScheme, 'https://invalid/')), throwsFormatException);
  });
}
